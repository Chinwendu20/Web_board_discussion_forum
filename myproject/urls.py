...
urlpatterns = [
    ...
    re_path	(r'^login/$', auth_views.LoginView.as_view(template_name='login.html',redirect_authenticated_user=True), 
    	name='login'),
    ...
    re_path(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z-]{1,40})/$', 
